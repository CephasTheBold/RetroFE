...
#  SDL3_MIXER_INCLUDE_DIRS - The location of the headers, e.g., SDL3_mixer/SDL_mixer.h.
...
#   SDL3_MIXER_INCLUDE_DIR - The directory that contains SDL3_mixer/SDL_mixer.h.
...
if(SDL3_MIXER_ROOT AND IS_DIRECTORY "${SDL3_MIXER_ROOT}/include" AND NOT SDL3_MIXER_INCLUDE_DIR)
  unset(SDL3_MIXER_INCLUDE_DIR CACHE)
endif()
...
if(SDL3_MIXER_INCLUDE_DIR AND EXISTS "${SDL3_MIXER_INCLUDE_DIR}/SDL3_mixer/SDL_mixer.h")
  file(STRINGS "${SDL3_MIXER_INCLUDE_DIR}/SDL3_mixer/SDL_mixer.h" SDL3_MIXER_VERSION_MAJOR_LINE REGEX "^#define[ \t]+SDL_MIXER_MAJOR_VERSION[ \t]+[0-9]+$")
  file(STRINGS "${SDL3_MIXER_INCLUDE_DIR}/SDL3_mixer/SDL_mixer.h" SDL3_MIXER_VERSION_MINOR_LINE REGEX "^#define[ \t]+SDL_MIXER_MINOR_VERSION[ \t]+[0-9]+$")
  file(STRINGS "${SDL3_MIXER_INCLUDE_DIR}/SDL3_mixer/SDL_mixer.h" SDL3_MIXER_VERSION_PATCH_LINE REGEX "^#define[ \t]+SDL_MIXER_MICRO_VERSION[ \t]+[0-9]+$")
