...
#  SDL3_TTF_INCLUDE_DIRS - The location of the headers, e.g., SDL3_ttf/SDL_ttf.h.
...
#   SDL3_TTF_INCLUDE_DIR - The directory that contains SDL3_ttf/SDL_ttf.h.
...
if(SDL3_TTF_ROOT AND IS_DIRECTORY "${SDL3_TTF_ROOT}/include" AND NOT SDL3_TTF_INCLUDE_DIR)
  unset(SDL3_TTF_INCLUDE_DIR CACHE)
endif()
...
if(SDL3_TTF_INCLUDE_DIR AND EXISTS "${SDL3_TTF_INCLUDE_DIR}/SDL3_ttf/SDL_ttf.h")
  file(STRINGS "${SDL3_TTF_INCLUDE_DIR}/SDL3_ttf/SDL_ttf.h" SDL3_TTF_VERSION_MAJOR_LINE REGEX "^#define[ \t]+SDL_TTF_MAJOR_VERSION[ \t]+[0-9]+$")
  file(STRINGS "${SDL3_TTF_INCLUDE_DIR}/SDL3_ttf/SDL_ttf.h" SDL3_TTF_VERSION_MINOR_LINE REGEX "^#define[ \t]+SDL_TTF_MINOR_VERSION[ \t]+[0-9]+$")
  file(STRINGS "${SDL3_TTF_INCLUDE_DIR}/SDL3_ttf/SDL_ttf.h" SDL3_TTF_VERSION_PATCH_LINE REGEX "^#define[ \t]+SDL_TTF_MICRO_VERSION[ \t]+[0-9]+$")
