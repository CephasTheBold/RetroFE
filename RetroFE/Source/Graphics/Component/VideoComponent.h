...
public:
    explicit VideoComponent(Page& p, const std::string& videoFile, int monitor, int numLoops = -1, bool softOverlay = false, int listId = -1, const int* perspectiveCorners = nullptr, bool priority = false);
