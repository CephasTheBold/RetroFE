...
void TweenSet::clearDynamicTweens() {
    // Instantly wipe only the math generated by ScrollingList, 
    // leaving the XML layout math 100% untouched!
    set_.erase(std::remove_if(set_.begin(), set_.end(), [](const Tween& t) {
        return t.dynamic;
        }), set_.end());
}
