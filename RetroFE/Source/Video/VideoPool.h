...
public:
    ...
    // Bulletproofing: Signal from GStreamer thread that an instance is now None/Ready
...
private:
    ...
    // Bulletproofing: Shared pointers ensure background threads don't access deleted pools
